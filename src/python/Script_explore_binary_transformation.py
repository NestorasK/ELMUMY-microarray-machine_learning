...
# Read Expressions
df_expr = pd.read_csv("data/processed_glp96_gpl570_platform/expression_rma.csv")
...
for thresholdi in thresholds:
    filei = f"data/processed_glp96_gpl570_platform/expression_binary_{thresholdi}.csv"
    print(filei)
    ...
    plt.ylabel("Counts")
    plt.savefig(f"data/processed_glp96_gpl570_platform/cors_of_cors_{thresholdi}.pdf")
